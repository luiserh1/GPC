...
function loadScene() {
    // Materiales
    // General
    var material = new THREE.MeshBasicMaterial({color:'red', wireframe:true}); // Material general
    ...
    */
    function planeMesh(lado)
    {
        ...
        plano = new THREE.Mesh(malla, material);
        return plano;
    }
   ...
   function pinzaGeometry(length)
   {
        ...
        malla.applyMatrix( new THREE.Matrix4().makeTranslation( -pivotX, -pivotY, -pivotZ ) );
    ...
    // modificaciḉon de una de ellas afectaría al resto
    ...
    // Las partes súoerpiezas como el brazo, antebrazo, mano etc. se definen con origen en (0,0,0) y después
